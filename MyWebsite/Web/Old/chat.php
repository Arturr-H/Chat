...
function scrollBottom() {window.scrollTo(0, 9999999);}
...
if(substr($comment, 0, 4) == "gif:"){
    if(strpos($comment, "http://") === false){
        ...
        $CurrentIPcolor = str_replace("\r\n","",$colors[array_rand($colors)]);
        file_put_contents($file, "<div class='textbox' style='background: linear-gradient(to right, $CurrentIPcolor 9.8px, white 9.8px) !important;'><a target='_blank' href='$gif'><button class='gifBtn'><img class='GifOrImage' src=", FILE_APPEND);
...
<div class="navigation-bar" id="navbg"><a href="/"><button class="navigation-button" tabindex="1" id="Home">Hem</button></a><a href="tutorial.html"><button class="navigation-button" tabindex="2" id="Help">Bruksanvisning</button></a><a href="regler.html"><button class="navigation-button" tabindex="3" id="Rules">Regler</button></a>
